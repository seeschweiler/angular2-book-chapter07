...
This is the repository of the sample applications from **chapter 07: Routing** from the book **Angular 2 - A Practical Introduction To The New Web Development Plattform**.
